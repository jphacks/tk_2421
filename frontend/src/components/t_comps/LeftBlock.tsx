      ...
      {num === 1 && !JSON.parse(tournament)[index]["isSeed"] ? (
        index % 2 === 0 ? (
          ...
          <div>
            ...
            />
            <LeftFirstBlock
              className="top-back bottom-basic right-back left-back"
              num={num}
            />
            <LeftFirstBlock
              className="top-back bottom-back right-back left-back"
        ...
        <div>
          ...
          />
          <LeftFirstBlock
            className="top-basic bottom-back right-basic left-back"
            num={num}
          />
          <LeftFirstBlock
            className="top-back bottom-basic right-basic left-back"
            num={num}
          />
          <LeftFirstBlock
            className="top-back bottom-back right-back left-back"
